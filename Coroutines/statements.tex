...
\setcounter{Paras}{1}
  ...
  equivalent to a \tcode{return} with no operand. Otherwise, flowing off the end of a function other than main (6.6.1) \added{or a coroutine (\ref{dcl.fct.def.coroutine})}
