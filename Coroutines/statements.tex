...
\pnum
A \tcode{for await} statement may only appear in a coroutine 
with an eventual return type, i.e a coroutine shall have the \tcode{return_value} or \tcode{return_void} member
...
\rSec2[stmt.return.coroutine]{The \tcode{return} statement in coroutines}%
%\enternote
...
that do not produce an eventual value or have an eventual return type of \tcode{void}. In the latter case, completion of the coroutine
