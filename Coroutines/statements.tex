...
\rSec2[stmt.for.await]{The cofor statement}%
...
\pnum
A \tcode{cofor} statement may only appear in a coroutine 
...
In paragraph 1 add productions for \tcode{coyield} and \tcode{coreturn} statement.
...
\begin{bnf}
	...
	\added{\terminal{coreturn} expression \terminal{;}}\br
  \added{\terminal{coreturn} braced-init-list{;}}\br
...
\pnum
Using a \tcode{return} statement in the coroutine makes the program ill-formed. 
