...
\begin{bnf}
	...
	\added{\terminal{coroutine-return-keyword} expression\opt \terminal{;}}\br
  \added{\terminal{coroutine-return-keyword} braced-init-list \terminal{;}}\br
  \added{\terminal{yield-keyword} expression \terminal{;}}\br
	\added{\terminal{yield-keyword} braced-init-list \terminal{;}}\br
...
\rSec2[stmt.coreturn]{The \tcode{coroutine-return-keyword} statement}%
...
\pnum
A coroutine returns to its caller by the \tcode{coroutine-return-keyword} statement
or when suspended at a suspend-resume point (\ref{dcl.fct.def.coroutine}). A \tcode{coroutine-return-keyword} statement shall not appear in a function other than a coroutine.
...
A \tcode{coroutine-return-keyword} statement with an expression of non-\tcode{void} type can be used only
...
\pnum
A \tcode{coroutine-return-keyword} statement with an expression of type \cvvoid{ }can be used only in functions without an eventual return type 
