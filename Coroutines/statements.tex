...
\begin{bnf}
	...
	\added{\terminal{return} expression\opt \terminal{;}}\br
  \added{\terminal{return} braced-init-list \terminal{;}}\br
...
\tcode{\textit{p}.return_value(\textit{operand})}. Flowing off the end of a coroutine is equivalent to a \tcode{return} with no value; this results in undefined behavior in a coroutine with non-\tcode{void} return type.
