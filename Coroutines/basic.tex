...
\added{An allocation function with exactly one argument or with all the arguments beyond the first having associated default values is a usual allocation function.}
\end{quote}