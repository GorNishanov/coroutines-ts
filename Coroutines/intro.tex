...
enables definition of coroutine functions. These extensions include 
...
%
%Add the definitions of ``suspend-resume-point'' and ``coroutine function''.
%
...
%
%\begin{quote}
%	\indexdefn{coroutine function}%
%	\definition{coroutine function}{defns.coroutine.function}
...
\begin{floattable}{Feature-test macros for coroutine functions}{tab:info.features}
{ll}
\topline
\lhdr{Macro name suffix} & \rhdr{Value} \\
\capsep
\tcode{coroutine}  & \tcode{201599}      \\
\end{floattable}
...
of a function\added{, suspension of a coroutine function (\ref{dcl.fct.def.coroutine})}, 
