...
deduced from \tcode{return},\added{ \tcode{coroutine-return-keyword}} statements, \added{ and \grammarterm{yield-expression}{}s} in the body of the function, if any.
\end{quote}
...
multiple \tcode{return}\added{, \tcode{coroutine-return-keyword}} statements\added{, and \grammarterm{yield-expression}{}s}, the return type is deduced for each
\tcode{return}\added{,
\tcode{coroutine-return-keyword}} statement\added{, and \grammarterm{yield-expression}}. If the type deduced is not the same in each
...
the return type is \tcode{std::experimental::async_stream<T>}, where \tcode{T} is deduced from the \grammarterm{yield-expression}{}s as if a \grammarterm{yield-expression} were a \tcode{return} statement in a function with declared type \tcode{auto} without a \grammarterm{trailing-return-type}.
