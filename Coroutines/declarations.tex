...
deduced from \tcode{return},\added{ \tcode{coreturn-keyword}, and \tcode{yield-keyword}} statements in the body of the function, if any.
\end{quote}
...
multiple \tcode{return}\added{, \tcode{coreturn-keyword}, and \tcode{yield-keyword}} statements, the return type is deduced for each
\tcode{return}\added{, \linebreak
\tcode{coreturn-keyword}, and \tcode{yield-keyword}} statement. If the type deduced is not the same in each
