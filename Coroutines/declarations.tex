...
\begin{itemize}
  ...
  \item \ldots
  \item \ldots
  \item \added{it shall not be resumable (\ref{dcl.fct.def.resumable})};
\end{itemize}
\end{quote}

\ednote{
  Though in the current proposal we do not allow constexpr resumable functions,
  we envision that generator style resumable function with yield statements
