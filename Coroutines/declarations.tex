...
\ednote{Incomplete edit. See if it can be integrated with paragraph 9.}
...
\begin{itemize}
\item If a \tcode{coyield} statement and either an \tcode{await} expression or a \tcode{cofor} statement are present, then
