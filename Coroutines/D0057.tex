...
\include{declarators}
%% \include{derived}
\include{special}\include{overloading}
%%\include{templates}
\include{support}
\include{threads}
...
% TODO: Clarify that yield_value, initial_suspend and final_suspend won't use await_transform
% TODO: Remove duplicate await_transform clauses
% TODO: Clarify free standing compatibility
% TODO: Something about section 8
% TODO: remove auto from return type in examples
