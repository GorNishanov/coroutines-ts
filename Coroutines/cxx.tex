...
\cxxsec{basic.start.main}{3.6.1}
\cxxsec{basic.stc.static}{3.7.1}
\cxxsec{basic.stc.thread}{3.7.2}
\cxxsec{basic.stc.auto}{3.7.3}
\cxxsec{basic.stc.dynamic.allocation}{3.7.4.1}
\cxxsec{basic.stc.dynamic.deallocation}{3.7.4.2}
