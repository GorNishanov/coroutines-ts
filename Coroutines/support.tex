...
\tcode{get_return_object} is invoked by the coroutine to construct the
...
is encountered in a coroutine or
...
\tcode{set_exception} is invoked by a coroutine when an
