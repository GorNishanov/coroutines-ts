...
a \tcode{coreturn-keyword} statement is encountered as described in (\ref{stmt.coreturn}).
...
\\ \rowsep
  ...
  when \tcode{yield_kw} statement is
  encountered in the coroutine. If
  promise does not define \tcode{yield_value}, \tcode{yield_kw}
