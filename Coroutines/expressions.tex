...
\begin{itemize}
	...
	\tcode{await_ready}, \tcode{await_suspend} and \tcode{await_resume} are
	are \tcode{__expr.await_ready()}, \tcode{__expr.await_suspend(_CoroutineHandle)} and \tcode{__expr.await_resume()},
	respectively;
...
\pnum
If await expression appears as unevaluated operands in
(\cxxref{expr.prim.req}, \cxxref{expr.typeid}, \cxxref{expr.sizeof}, 
