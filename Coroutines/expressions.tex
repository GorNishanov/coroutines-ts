...
\pnum
The await operator is used to suspend evaluation of the enclosing resumable function until the asynchronous operation represented by the operand has completed.
