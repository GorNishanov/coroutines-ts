...
\pnum
The presence of an \tcode{await} operator in a potentially-evaluated expression makes the enclosing function a coroutine.
...
\pnum
An \tcode{await} expression may only appear in a coroutine 
